...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-PuppetDB-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="c4.4xlarge"
aws_rootdisk_gb="200"
aws_datadisk_gb="200"
aws_elb_name=""
role="Puppet4-DB"
