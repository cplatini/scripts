...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-HDD-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.xlarge"
aws_rootdisk_gb="20"
aws_datadisk_gb="20"
aws_elb_name="${sdlc}-HDD"
role="HDD"
app_id="144"
