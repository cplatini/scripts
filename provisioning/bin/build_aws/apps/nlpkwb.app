...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-NLPKWB-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.xlarge"
aws_rootdisk_gb="20"
aws_datadisk_gb="20"
aws_elb_name="${sdlc}-NLPWorkbench"
role="NLPKWB"
app_id="105"
