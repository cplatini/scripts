...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-NLPE-App*" --query 'SecurityGroups[*].GroupId')
if [ "${sdlc}" == "pr" ]
then
  aws_subnet_fltr="*VPC-PROD NLP Private*"
fi
aws_flavor="r3.xlarge"
aws_rootdisk_gb="20"
aws_datadisk_gb="30"
role="NLPD"
app_id="127"
