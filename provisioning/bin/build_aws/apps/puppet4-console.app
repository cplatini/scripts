...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-PuppetConsole-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.xlarge"
aws_rootdisk_gb="100"
aws_datadisk_gb="50"
aws_elb_name=""
role="Puppet4-Console"
