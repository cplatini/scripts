...
# Version: 0.0.7
# Date: 2016-03-16
# Application: HSARABBITMQ

## Set the app specific Vars
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-HSARABBITMQ-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.large"
aws_rootdisk_gb="20"
aws_datadisk_gb="20"
aws_elb_name="${sdlc}-HSARABBITMQ"
role="HSARABBITMQ"
