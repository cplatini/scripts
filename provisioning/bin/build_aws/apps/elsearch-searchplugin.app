...
# Version: 0.0.1
# Date: 2016-04-11
# Application: ELSearch Central Logging Plugin Node

## Set the app specific Vars
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-ELSEARCH-SEARCH*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.xlarge"
aws_datadisk_gb="20"
aws_elb_name=${sdlc}-elsearch-log
role="ELSEARCH-SEARCH-Plugin"
app_id="105"
...
printf "[centos-sclo-rh]\\\nname=centos-sclo-rh\\\nbaseurl=http://${yumserver_name}/centos-sclo-rh\\\nenabled=1\\\ngpgcheck=0\\\n" | tee /etc/yum.repos.d/centos-sclo-rh.repo
yum -y remove puppet puppetlabs-release
