...
# Version: 0.0.1
# Date: 2016-10-31
# Application: PMDTS (PM Data-Transfer Service)

## Set the app specific Vars
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-PMDTS-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="c4.2xlarge"
aws_rootdisk_gb="100"
aws_datadisk_gb="15"
aws_elb_name="${sdlc}-pmdts"
role="PMDTS-APP"
app_id="124"
