...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-PIMS-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="c4.2xlarge"
aws_rootdisk_gb="100"
aws_datadisk_gb="15"
aws_elb_name="${sdlc}-pims"
role="PIMS"
app_id="120"
