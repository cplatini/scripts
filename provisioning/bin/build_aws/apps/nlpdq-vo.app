...
aws_group=$(${aws_cli_base} ec2 describe-security-groups --filter Name=group-name,Values="*${aws_env_fltr}-NLPQ-VO-App*" --query 'SecurityGroups[*].GroupId')
aws_flavor="m4.2xlarge"
aws_rootdisk_gb="60"
aws_datadisk_gb="15"
aws_elb_name="${sdlc}-NLPQ-VO"
role="NLPDQ"
app_id="127"
