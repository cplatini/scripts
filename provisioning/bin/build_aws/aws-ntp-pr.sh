...
aws_subnet="subnet-ae680f84"
aws_group="sg-5f2a9e24"
...
## Clean old instance
ec2-terminate-instances $(ec2-describe-instances -F "vpc-id=${aws_vpc}" -F tag:Name=${hostname}-${node} | grep INSTANCE | grep -v terminated | awk '{ print $2}')
}
