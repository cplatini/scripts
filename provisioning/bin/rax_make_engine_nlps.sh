...
s_build_update='[Wed Feb 10 16:21:23 UTC 2016]' # Change me, if changes are made
...
###########################################
  case "${VM_TYPE}" in
      HDD)
        ...
        ;;
      NLPD)
        # nlp_standard - 2 vCPUs, 32G memory, 60G disk, 0 ephemeral
...
###########################################
  case "${VM_TYPE}" in
      HDD)
        ...
        ;;
      NLPD)
        # m2.2xlarge - 2 vCPUs, 32G memory, 30G disk, 0 ephemeral
        OS_FLAVOR='30f17cc0-7c8c-4b23-b86d-f14aa8b2c673'
        ;;
      NLPR)
        # m2.2xlarge - 2 vCPUs, 32G memory, 30G disk, 0 ephemeral
        OS_FLAVOR='30f17cc0-7c8c-4b23-b86d-f14aa8b2c673'
